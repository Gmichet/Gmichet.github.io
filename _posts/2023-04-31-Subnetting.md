...
layout: post
date: 2023-04-31-Subnetting.md 00:00:00 +0800
categories: Redes
tags: Subnetting
...
- [Qué es una dirección IPv4.](#direccion-ipv4)
- [Clase de dirección IP y rango en el que opera.](#clases-y-rangos)
- [Interpretación de una Máscara de Red.](#interpretar-una-máscara-de-red)
- [Representación por CIDR](#cálculo-general-por-cidr)
- [Convertir la dirección IP y máscara de subred a binario.](#1-calcular-dirección-ip-y-máscara-de-red-en-binario)
- [Comparando la dirección IP y máscara de red para revelar la primera IP.](#2-operación-and)
- [Sacando el total de Hosts.](#3-cálculo-de-hosts-a-repartir)
- [Obteniendo la última dirección IP válida en un rango de subred](#4-cálculo-del-broadcast-address)
- [Dato de red obtenidos por cálculo CIDR](#resumen)
- [Página de ayuda para verificar respuestas](#verificando-respuestas)
...
- Bits en 1: Indican la parte de Red.
- BIts en 0: Indican la parte de Host.
...
- Si uno de los bits es 0, el resultado es 0.
- Si ambos bits son 0, el resultado es 0.


#### 3 CÁLCULO DE HOSTS A REPARTIR
...
#### 4 CÁLCULO DEL BROADCAST ADDRESS
...
- La dirección de red (first ip) y la dirección de broadcast (last ip) juntas definen la subred completa.
